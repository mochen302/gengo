...
type Defaulted struct {
	...
	// +default=ref(github.com/mochen302/gengox/examples/defaulter-gen/_output_tests/marker/external.AConstant)
	SameNamePackageSymbolReference1 string

	// +default=ref(github.com/mochen302/gengox/examples/defaulter-gen/_output_tests/marker/external/external.AnotherConstant)
